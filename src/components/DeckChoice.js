...
function DeckChoice ({ heroes, heroesChosen, addToDeck, removeDeck }) {
  return (
    <div>
      <NavBarDeckChoice heroesChosen={heroesChosen} />
      <div id='container-deck-card'>
        <DeckList heroes={heroes} heroesChosen={heroesChosen} addToDeck={addToDeck} removeDeck={removeDeck} />
